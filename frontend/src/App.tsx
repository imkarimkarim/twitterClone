  ...
  return (
    <>
      <div
        ...
        style={{
          display: toggleComposeTweet === true ? "flex" : "none",
        }}
      >
        ...
        <main>
          <div className="twitter-profile-main">
            ...
            <div className="twitter-profile-main-description">
              ⚛️ Software Developer | 🌅 Technical Writer | 🎨 Content
              Creator | 📝 1 Million+ Subscribers
            </div>
          ...
          {loading ? (
            ...
            <div>
              {data?.map((tweet: any) => (
                <div
                  className="twitter-profile-main-tweets"
                  key={tweet._id}
                >
